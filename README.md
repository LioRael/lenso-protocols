...
Generated Rust Clients also implement `lenso_module::CapabilityClient`. This
is the portable seam used by lifecycle-bound `Port<C>` fields: Module glue can
connect a whole generated Client from Plan-owned dependencies without knowing
its request, stream, or Event handle layout. Rust Capability crates generated
with this version must depend on `lenso-module`.
